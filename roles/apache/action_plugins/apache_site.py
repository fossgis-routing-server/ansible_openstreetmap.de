...
class ActionModule(ActionBase):
    def run(self, tmp=None, task_vars=None):
        ...
        if state == 'present':
            ...
            new_task_vars['apache__site_body'] = self._task.args.get('src')
        ...
        module_args = {
            'argv': ['a2dissite' if state == 'absent' else 'a2ensite', site]
        }

        next_result = self._execute_module('ansible.builtin.command',
